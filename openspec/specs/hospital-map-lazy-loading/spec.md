# hospital-map-lazy-loading Specification

## Purpose

TBD - created by archiving change 'lazy-load-hospital-map-leaflet'. Update Purpose after archive.
...
<!-- @trace
source: lazy-load-hospital-map-leaflet
updated: 2026-07-13
code:
  - src/router/index.js
tests:
