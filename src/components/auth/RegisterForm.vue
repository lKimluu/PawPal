...
<template>
  <main class="login-form-page flex h-full items-start justify-center px-4 pt-8 pb-10">
    ...
    >
      ...
      <div class="space-y-4">
        <label class="block">
          <span class="mb-2 block text-sm font-bold text-brand-navy">姓名</span>
          <input
        ...
        <label class="block">
          <span class="mb-2 block text-sm font-bold text-brand-navy">再次確認密碼</span>
          <input
            class="h-11 w-full rounded-xl border-0 bg-[#F3F4F8] px-4 text-[14px] font-medium text-brand-navy outline-none transition placeholder:text-brand-gray/50 focus:ring-2 focus:ring-brand-blue"
            type="password"
            placeholder="••••••••"
      ...
      <button
        class="mt-5 h-11 w-full rounded-xl bg-brand-orange text-sm font-bold text-brand-white shadow-[0_4px_18px_rgba(255,160,2,0.32)] transition hover:bg-[#e89000] focus:outline-none focus:ring-2 focus:ring-brand-orange focus:ring-offset-2 cursor-pointer"
        type="submit"
      ...
      <div class="my-6 flex items-center gap-3">
        ...
        <span class="text-xs lg:text-sm font-medium text-brand-gray">或使用以下方式註冊</span>
        <span class="h-px flex-1 bg-[#DDE5FC]"></span>
      </div>
      ...
      <div class="w-full">
        ...
        <button
          class="flex h-11 w-full items-center justify-center gap-3 rounded-xl bg-white text-sm font-semibold text-brand-navy shadow-[0_4px_14px_rgba(31,41,55,0.13)] ring-1 ring-[#DDE5FC] transition active:scale-[0.98] hover:bg-[#F3F4F8] cursor-pointer mt-3"
          type="button"
          @click="loginWithLine"
        >
      ...
      <ul class="mt-7 flex items-center justify-center gap-1 text-sm font-bold">
